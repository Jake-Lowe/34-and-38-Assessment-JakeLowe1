...
/**************************************************************/
// ad_processUSERReadAll(_data, _dbRec)
...
function ad_processUSERReadAll(_data, _dbRec) {
  console.log('ad_processUSERReadAll: '+_data);
  ...
  if (_dbRec != null) {  
    ...
    ad_displayAll("t_userData", ad_adminArray, true,                     
      "startScreen", "gamePage", "adminPage", 7, DETAILS);        //<=======
  }
}

/**************************************************************/
// ad_processBBReadAll(_data, _dbRec)
...
/*************************************************************
*/
function ad_processBBReadAll(_data, _dbRec) {
  console.log('ad_processBBReadAll: ', 'result = ' + _data);
...
function ad_displayAll(_tableId, _array, _action, _hideId1, _hideId2, _showId, _item, _path) {
  console.log('ad_displayAll: '+ _path);
